...
function NoteDetailPage() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:5261/api/Notes/${id}`)
      .then((response) => {
  ...
  const galleryImages = note.images && note.images.length > 0 
    ? note.images.map(img => img.imageUrl) 
    : [
        "https://placehold.co/600x800/e2e8f0/475569?text=Note+Cover+Image",
        "https://placehold.co/600x800/e2e8f0/475569?text=Page+1+Demo",
        "https://placehold.co/600x800/e2e8f0/475569?text=Page+2+Demo"
      ];
